##The first step is to read the tables and join them for the training and test data
...
##joins both tables, for train and test group and sets the result at "tabela". This completes the assignment given on "STEP 4"

	tabela<- rbind(tabelaTrain, tabelaTest)


##The final step is to average the table fields created on step 4 if the assignment. 
...
## inputs the text "average of" before each variable to clarify their meaning

	names(tabelamean)[3:81] <- paste("average of ",names(tabela3)[3:81])

## write the final table into an excel file. This completes the assignment fiven on "STEP 5"
...
######################################################################
##The code below creates the Codebook#################################
######################################################################

	##Reads the fields names
